                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-gray-dark card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Create User Additional Info</h3>
                        ...
                        {!! Form::open(['url' => route('backend.ums.user-additional-info.store'), 'method' => 'user-additional-info', 'files' => true]) !!}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="phone_no" name="phone_no" value="{{ old('phone_no') }}" type="text" class="form-control @error('phone_no') is-invalid @enderror" placeholder="Enter phone no" autofocus>
                                            @error('phone_no')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="mobile_no" name="mobile_no" value="{{ old('mobile_no') }}" type="text" class="form-control @error('mobile_no') is-invalid @enderror" placeholder="Enter mobile no" autofocus>
                                            @error('mobile_no')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="fax_no" name="fax_no" value="{{ old('fax_no') }}" type="text" class="form-control @error('fax_no') is-invalid @enderror" placeholder="Enter fax no" autofocus>
                                            @error('fax_no')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="personal_email" name="personal_email" value="{{ old('personal_email') }}" type="text" class="form-control @error('personal_email') is-invalid @enderror" placeholder="Enter personal email" autofocus>
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="professional_email" name="professional_email" value="{{ old('professional_email') }}" type="text" class="form-control @error('professional_email') is-invalid @enderror" placeholder="Enter professional email" autofocus>
									...
									<div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input id="dob" name="dob" value="{{ old('dob') }}" type="text" class="form-control datepicker @error('dob') is-invalid @enderror" placeholder="Enter dob" autofocus>
                                            @error('dob')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="blood_group" name="blood_group" class="form-control @error('blood_group') is-invalid @enderror">
                                                ...
                                                @foreach(config('core.blood_groups') as $blood_group_key => $blood_group)
                                                    <option
                                                            value="{{ $blood_group_key }}">{{ $blood_group }}</option>
                                                @endforeach
                                            </select>
                                            @error('blood_group')
                                            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
