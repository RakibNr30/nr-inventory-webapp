                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-gray-dark card-outline">
                        <div class="card-header">
                            <h3 class="card-title mt-1">Add new Influencer</h3>
                        ...
                        {!! Form::open(['url' => route('backend.ums.influencer.store'), 'method' => 'influencer', 'files' => true]) !!}
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="instagram_username" name="instagram_username" value="{{ old('instagram_username') }}"
                                               type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="instagram_followers" name="instagram_followers" value="{{ old('instagram_followers') }}"
                                               type="number" min="0"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="tiktok_username" name="tiktok_username" value="{{ old('tiktok_username') }}"
                                               type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="tiktok_followers" name="tiktok_followers" value="{{ old('tiktok_followers') }}"
                                               type="number" min="0"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="shipping_first_name" name="shipping_first_name" value="{{ old('shipping_first_name') }}"
                                               type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="shipping_last_name" name="shipping_last_name" value="{{ old('shipping_last_name') }}"
                                               type="text"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="extra_info" name="extra_info" value="{{ old('extra_info') }}"
                                               type="text"
