                                        ...
                                        @foreach($campaign_influencers as $index => $campaign_influencer)
                                            <tr>
                                                @php
                                                    ...
                                                    $uploaded_content = 0;
                                                    foreach(range(1, $campaign_influencer->cycle_count) as $index_cycle => $cycle) {
                                                    ...
                                                    $total_contents = $campaign_influencer->cycle_count;
                                                ...
                                                @php
                                                    $reviewed = 0;
                                                    foreach(range(1, $campaign_influencer->cycle_count) as $index_cycle => $cycle) {
                                                        $admin_review = 'grade_' . $campaign_influencer->id . '_' . $cycle;
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                            @foreach(range(1, $campaign_influencer->cycle_count) as $cycle)
                                                                                @php
                                                                                    $admin_review_grade = 'grade_' . $campaign_influencer->id . '_' . $cycle;
                                                                                    $admin_review_feedback = 'feedback_' . $campaign_influencer->id . '_' . $cycle;
                                                                                @endphp
