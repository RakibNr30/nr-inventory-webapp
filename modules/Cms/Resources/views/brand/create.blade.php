                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="brand_priority" name="brand_priority" value="{{ old('brand_priority') }}" type="number" min="0" class="form-control @error('brand_priority') is-invalid @enderror" placeholder="Enter priority" autofocus>
