<div class="btn-group">
    <a href="{{ route('backend.cms.brand.show', [$data->id]) }}" type="button" class="btn btn-default">
        <i class="fas fa-eye"></i>
    </a>
    <a href="{{ route('backend.cms.brand.edit', [$data->id]) }}" type="button" class="btn btn-default">
    ...
    {!! Form::open(['url' => route('backend.cms.brand.destroy', [$data->id]), 'method' => 'delete', 'id' => 'delete_form' . $data->id]) !!}{!! Form::close() !!}
</div>
