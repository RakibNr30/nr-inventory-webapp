                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                        @if(isset($campaign->logo))
                                            <div class="image-output">
                                                <img src="{{ $campaign->logo->file_url }}">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input id="instagram_story" name="instagram_story" value="{{ old('instagram_story') ?? $campaign->instagram_story }}" type="number" min="0" max="100" class="form-control percentages @error('instagram_story') is-invalid @enderror" placeholder="" autofocus>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input id="instagram_feed" name="instagram_feed" value="{{ old('instagram_feed') ?? $campaign->instagram_feed }}" type="number" min="0" max="100" class="form-control @error('instagram_feed') is-invalid @enderror" placeholder="" autofocus>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input id="instagram_reel" name="instagram_reel" value="{{ old('instagram_reel') ?? $campaign->instagram_reel }}" type="number" min="0" max="100" class="form-control @error('instagram_reel') is-invalid @enderror" placeholder="" autofocus>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input id="instagram_igtv" name="instagram_igtv" value="{{ old('instagram_igtv') ?? $campaign->instagram_igtv }}" type="number" min="0" max="100" class="form-control @error('instagram_igtv') is-invalid @enderror" placeholder="" autofocus>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    ...
                                                    <input id="tiktok_video" name="tiktok_video" value="{{ old('tiktok_video') ?? $campaign->tiktok_video }}" type="number" min="0" max="100" class="form-control @error('tiktok_video') is-invalid @enderror" placeholder="" autofocus>
                                                    @error('tiktok_video')
                                                    <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                                    @enderror
                                                </div>
                                ...
                                <div class="col-md-12">
                                    <table class="table w-100 mb-0">
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" name="extra_content_1" placeholder="Your requirement" class="form-control extra_content" value="{{ old('extra_content_1') ?? $campaign->extra_content_1 }}">
                                                    <input id="extra_content_1_value" name="extra_content_1_value" value="{{ old('extra_content_1_value') ?? $campaign->extra_content_1_value }}" type="number" min="0" max="100" class="form-control percentages @error('extra_content_1_value') is-invalid @enderror" placeholder="" autofocus>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" name="extra_content_2" placeholder="Your requirement" class="form-control extra_content" value="{{ old('extra_content_2') ?? $campaign->extra_content_2 }}">
                                                    <input id="extra_content_2_value" name="extra_content_2_value" value="{{ old('extra_content_2_value') ?? $campaign->extra_content_2_value }}" type="number" min="0" max="100" class="form-control percentages @error('extra_content_2_value') is-invalid @enderror" placeholder="" autofocus>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" name="extra_content_3" placeholder="Your requirement" class="form-control extra_content" value="{{ old('extra_content_3') ?? $campaign->extra_content_3 }}">
                                                    <input id="extra_content_3_value" name="extra_content_3_value" value="{{ old('extra_content_3_value') ?? $campaign->extra_content_3_value }}" type="number" min="0" max="100" class="form-control percentages @error('extra_content_3_value') is-invalid @enderror" placeholder="" autofocus>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" name="extra_content_4" placeholder="Your requirement" class="form-control extra_content" value="{{ old('extra_content_4') ?? $campaign->extra_content_4 }}">
                                                    <input id="extra_content_4_value" name="extra_content_4_value" value="{{ old('extra_content_4_value') ?? $campaign->extra_content_4_value }}" type="number" min="0" max="100" class="form-control percentages @error('extra_content_4_value') is-invalid @enderror" placeholder="" autofocus>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <input type="text" name="extra_content_5" placeholder="Your requirement" class="form-control extra_content" value="{{ old('extra_content_5') ?? $campaign->extra_content_5 }}">
                                                    <input id="extra_content_5_value" name="extra_content_5_value" value="{{ old('extra_content_5_value') ?? $campaign->extra_content_5_value }}" type="number" min="0" max="100" class="form-control percentages @error('extra_content_5_value') is-invalid @enderror" placeholder="" autofocus>
