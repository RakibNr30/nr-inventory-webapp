...
<!--                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="product_id" name="product_id" value="{{ old('product_id') ?? $product->product_id }}" type="text" class="form-control @error('product_id') is-invalid @enderror" placeholder="Enter product id" autofocus>
                                        @error('product_id')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                        @enderror
                                    </div>
