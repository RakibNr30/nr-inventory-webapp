    ...
    <div class="register-box step-2">
        <div class="card card-outline card-primary mb-2 mt-2">
            ...
            <div class="card-body login-card-body">
                ...
                {!! Form::open(['route' => 'register.almost-ready.store', 'method' => 'post']) !!}
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="input-group mb-3">
                            <input id="gender" name="gender" placeholder="Gender" value="{{ old('gender') }}" type="text" class="form-control @error('gender') is-invalid @enderror" required>
                            <div class="input-group-append">
                                <div class="input-group-text">
                                    <span class="fas fa-instagram"></span>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="input-group mb-3">
                            <input id="photo" name="photo" placeholder="Profile Picture" value="{{ old('photo') }}" type="text" class="form-control @error('photo') is-invalid @enderror" required>
                            <div class="input-group-append">
                                <div class="input-group-text">
                                    <span class="fas fa-instagram"></span>
                                </div>
